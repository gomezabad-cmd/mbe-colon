...
export const metadata = {
  title: 'Bordados en Uniformes y Gorras para Empresas | MBE Colón',
  ...
  alternates: {
    canonical: 'https://mbecolon.com/blog/bordados-personalizados-uniformes-colon',
  },
  openGraph: {
    title: 'Bordados en Uniformes y Gorras para Empresas | MBE Colón',
    description: 'Bordados personalizados para uniformes, hoodies y gorras en Colón. Diseños únicos, desde 1 unidad, alta calidad y durabilidad garantizada. MBE Colón.',
    url: 'https://mbecolon.com/blog/bordados-personalizados-uniformes-colon',
    siteName: 'MBE Colón',
    locale: 'es_PA',
    type: 'article',
    images: [
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14">
        ...
        <p className="text-gray-500 text-sm mb-8 border-b border-gray-200 pb-6">
          Por <strong className="text-mbe-dark">Carlos Gómez</strong> · Franquiciado de MBE Colón · Tu guía para uniformes bordados profesionales en la provincia de Colón
        </p>
        <p className="text-mbe-dark text-lg font-medium leading-relaxed bg-mbe-light rounded-2xl p-6 border-l-4 border-mbe-red mb-8">
          Puedes bordar uniformes, hoodies y gorras con tu logo en MBE Colón desde una sola unidad. El bordado cuesta desde $3.75 por prenda e incluye la digitalización del logotipo; el tiempo estándar es de 5 a 10 días hábiles y los pedidos corporativos de 50 prendas o más tardan de 10 a 15 días.
        </p>
