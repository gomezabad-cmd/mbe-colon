...
export const metadata = {
  ...
  openGraph: {
    title: 'Gorras y Polos Bordados para Empresas | MBE Colón',
    description: '¿Buscas bordados en Colón para tu empresa? Gorras y polos bordados con logo, alta calidad y entrega rápida en Plaza Millenium F007, Panamá.',
    url: 'https://mbecolon.com/blog/bordados-gorras-polos-empresas-colon',
    siteName: 'MBE Colón',
    locale: 'es_PA',
    type: 'article',
    images: [
      { url: 'https://images.unsplash.com/photo-1516762689617-e1cffcef479d?w=1200&h=630&fit=crop&q=80', width: 1200, height: 630, alt: 'Gorras y Polos Bordados con Logo para Empresas en Colón, Panamá' },
    ],
  },
}
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14">
        ...
        <p className="text-mbe-dark text-lg font-medium leading-relaxed bg-mbe-light rounded-2xl p-6 border-l-4 border-mbe-red mb-8">
          En MBE Colón puedes encargar gorras y polos bordados con el logo de tu empresa desde 1 sola pieza. El precio arranca en $3.75 por prenda, incluye la digitalización del logotipo y se entrega en 5 a 10 días hábiles; las gorras salen en 3 a 5 días y hay opción urgente con recargo del 30%.
        </p>
